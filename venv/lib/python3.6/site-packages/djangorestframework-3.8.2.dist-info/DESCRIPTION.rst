...
-  The `Web browsable API <https://restframework.herokuapp.com/>`__ is a
...
here <https://restframework.herokuapp.com/>`__.
...
```curl`` <https://curl.haxx.se/>`__. For example, to list the users
endpoint:
...
.. |build-status-image| image:: https://secure.travis-ci.org/encode/django-rest-framework.svg?branch=master
   :target: https://travis-ci.org/encode/django-rest-framework?branch=master
.. |coverage-status-image| image:: https://img.shields.io/codecov/c/github/encode/django-rest-framework/master.svg
   :target: https://codecov.io/github/encode/django-rest-framework?branch=master
...
.. |image3| image:: https://raw.githubusercontent.com/encode/django-rest-framework/master/docs/img/premium/rover-readme.png
   :target: http://jobs.rover.com/
.. |image4| image:: https://raw.githubusercontent.com/encode/django-rest-framework/master/docs/img/premium/sentry-readme.png
   :target: https://getsentry.com/welcome/
.. |image5| image:: https://raw.githubusercontent.com/encode/django-rest-framework/master/docs/img/premium/stream-readme.png
   :target: https://getstream.io/try-the-api/?utm_source=drf&utm_medium=banner&utm_campaign=drf
.. |image6| image:: https://raw.githubusercontent.com/encode/django-rest-framework/master/docs/img/premium/machinalis-readme.png
   :target: https://hello.machinalis.co.uk/
.. |image7| image:: https://raw.githubusercontent.com/encode/django-rest-framework/master/docs/img/premium/rollbar-readme.png
